 ...
 * 2014-08-07T13:47:50.287+08:00
 * Generated source version: 2.7.5
 * 
 */
@WebServiceClient(name = "Weather", 
                  wsdlLocation = "file:/home/martin/git/Sample/weather-client/src/main/resources/weather.wsdl",
...
public class Weather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/martin/git/Sample/weather-client/src/main/resources/weather.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Weather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/martin/git/Sample/weather-client/src/main/resources/weather.wsdl");
        }
        WSDL_LOCATION = url;
    }
